...
namespace ChoreTrackerAPI.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChoreCompletion_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChoreCompletion_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Notifications_Chores_ChoreId",
                        column: x => x.ChoreId,
                        principalTable: "Chores",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            // Chore indexes
            migrationBuilder.CreateIndex(
                name: "IX_Chore_GroupId",
                table: "Chores",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_Chore_NextOccurence",
                table: "Chores",
                column: "NextOccurence");

            migrationBuilder.CreateIndex(
                name: "IX_Chore_Status",
                table: "Chores",
                column: "Status");

            // ChoreCompletion indexes
            migrationBuilder.CreateIndex(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChoreCompletion_CompletedOn",
                table: "ChoreCompletion",
                column: "CompletedOn");

            migrationBuilder.CreateIndex(
                name: "IX_ChoreCompletion_GroupId",
                table: "ChoreCompletion",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_ChoreCompletion_UserId",
                table: "ChoreCompletion",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ChoreCompletion_GroupId_CompletedOn",
                table: "ChoreCompletion",
                columns: new[] { "GroupId", "CompletedOn" });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "ChoreCompletion");
            migrationBuilder.DropTable(name: "GroupMember");
